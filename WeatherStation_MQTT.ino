 ...
 *  
 *  Last edit: 2020 03 01
 *      - filter out results > 50 m/s due to faulty trigged rotations
 * 
 */
...
//Constants
const char *wifi_ssid                    = "GuestHosMange";
const char *wifi_pwd                     = "Magnus123";
const char *wifi_hostname                = "WeatherStation";
const char* mqtt_server                  = "192.168.1.201";      // MQTT Boker IP, your home MQTT server eg Mosquitto on RPi, or some public MQTT
const int mqtt_port                      = 1883;                 // MQTT Broker PORT, default is 1883 but can be anything.
const char *mqtt_user                    = "admin";              // MQTT Broker User Name
const char *mqtt_pwd                     = "8a3djWmrPTXvP&";     // MQTT Broker Password 
